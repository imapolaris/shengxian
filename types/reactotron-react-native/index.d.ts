declare module 'reactotron-react-native' {
    ...
    export type PluginCreator = (reactotron:Reactotron)=>Reactotron
    /**
     * Reactotron.
     */
    export interface Reactotron {
        ...
        use(pluginCreator:PluginCreator):Reactotron
        /**
        ...
        // saga
        createSagaMonitor:(options?:any)=>Monitor
    }

    export var instance: Reactotron;
}